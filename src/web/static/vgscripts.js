...
EXTIMG = 0
function selSearch(evt) {
  selWidth = el("cropbox").width;
  selHeight = el("cropbox").height;
  //alert("x1=" + selXMin + " y1=" + selYMin + " x2=" + selXMax + " y2=" + selYMax);
  //var xr = 720 / selWidth;
  //var yr = 576 / selHeight;
  var use_qe = false;
  var xr = 1.0;
  var yr = 1.0;
  if (!EXTIMG) {
    var xmin = (selXMin * xr).toFixed(0);
    var xmax = (selXMax * xr).toFixed(0);
    var ymin = (selYMin * yr).toFixed(0);
    var ymax = (selYMax * yr).toFixed(0);
  }
  else {
    var xmin = selXMin;
    var xmax = selXMax;
  ...
  var href = URLBASE + '&x1=' + String(xmin)
                     + '&y1=' + String(ymin)
                     + '&x2=' + String(xmax)
                     + '&y2=' + String(ymax)
                     + '&width_on_page=' + String(selWidth)
                     + '&height_on_page=' + String(selHeight)
                     + '&use_qe=' + String(use_qe);

  //var href = URLBASE + '&minX=' + String(xmin)
  //         + '&maxX=' + String(xmax) + '&minY=' + String(ymin) + '&maxY=' + String(ymax)
  //         + '&frame_width=' + String(selWidth) + '&frame_height=' + String(selHeight)
  //         + '&range1=1&range2=10&iwidth=' + String(selWidth) + '&iheight=' + String(selHeight)
  //         + '&x_size=' + String(selWidth) + '&y_size=' + String(selHeight) + '&ominx=' + String(xmin)
  //         + '&omaxx=' + String(xmax) + '&ominy=' + String(ymin) + '&omaxy=' + String(ymax);
